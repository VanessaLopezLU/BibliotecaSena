...
public interface EstadoUserAPI {
    @POST("estado-usuario/crear")
    <CreateEstadoUsuarioDto> // Ruta para crear un Estado Usuario
    Call<EstadoUsuario> crearEstado(@Body CreateEstadoUsuarioDto createEstadoUsuarioDto);
